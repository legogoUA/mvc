...
controller.addItem("Cook diner.");
controller.addItem("Walk around.");
controller.addItem("Clean house.");
controller.addItem("Create project.");
controller.addItem("Complete task.");
controller.addItem("Watch course.");
controller.addItem("Write code.");
controller.addItem("Learn JavaScript.");
controller.addItem("Read book.");
controller.addItem("Write email.");
controller.addItem("Create ToDo.");
